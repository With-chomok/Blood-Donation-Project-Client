    ...
    <div className="flex  min-h-screen relative font-sans">
      ...
      <AnimatePresence>
        {isSidebarOpen && (
          <motion.div
            ...
            className="fixed inset-0 bg-black/60 backdrop-blur-sm z-40 lg:hidden"></motion.div>
        )}
      </AnimatePresence>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="lg:hidden  backdrop-blur-md border-b border-gray-100 p-4 flex justify-between items-center sticky top-0 z-30">
          ...
          <img
            className="flex items-center justify-center border border-red-500  text-red-600 w-10 h-10 rounded-full object-cover"
            src={user.photoURL}
            alt=""
          />
        </header>
