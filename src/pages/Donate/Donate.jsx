  ...
  return (
    <motion.div
      ...
      <motion.div initial={{ x: -20 }} animate={{ x: 0 }} className="mb-8">
        <Link
           to='/dashboard'
          className="flex items-center gap-2 text-base-content hover:text-red-600 font-bold transition-all group">
      ...
      <div className="text-center mb-12">
        ...
        <p className="section-subtitle">
          Your small contribution plays a huge role in maintaining our emergency
      ...
      <motion.div
        ...
        <div className="absolute -inset-1 rounded-3xl blur opacity-20"></div>

        <div className="relative p-10 rounded-3xl shadow-sm border border-gray-50">
          <form onSubmit={handleDonate} className="space-y-6">
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  placeholder="0.00"
                  className="input input-bordered border-gray-200 focus:border-red-500 focus:ring-4 focus:ring-red-50 rounded-2xl w-full pl-10 h-16 text-2xl font-black  outline-none shadow shadow-red-100 transition-all"
                />
              </div>
            </div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="btn bg-red-600 hover:bg-red-700 text-white w-full rounded-2xl border-none h-16 text-xl font-bold shadow transition-all">
              Confirm Donation
            </motion.button>
        ...
        {[
          {
            icon: <FaShieldAlt />,
            title: "Platform Care",
            desc: "Covers hosting and security costs to keep your data safe.",
          },
          {
            icon: <FaGlobeAsia />,
            title: "Expansion",
            desc: "Helps us reach donors in the most remote areas of the country.",
          },
          {
            icon: <FaHeart />,
            title: "Free Service",
            desc: "Ensures LifeDrop remains 100% free for patients and donors.",
          },
        ].map((item, idx) => (
          <motion.div
            key={idx}
