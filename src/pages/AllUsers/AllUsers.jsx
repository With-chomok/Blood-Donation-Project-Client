                    ...
                    <div className="dropdown dropdown-left">
                      ...
                      <ul
                        ...
                        {user.role !== "volunteer" && (
                          <li>
                            <button
                              ...
                              className="hover:bg-blue-50 text-blue-600 font-medium">
                              🛠️ Make Volunteer
                            </button>
                          </li>
                        )}
                        ...
                        {user.role !== "admin" && (
                          <li>
                            <button
                              ...
                              className="hover:bg-purple-50 text-purple-600 font-medium">
                              👑 Make Admin
                            </button>
                          </li>
                        )}
                        ...
                        {user.role !== "donor" && (
                          <li>
                            <button
                              onClick={() => updateRole(user.email, "donor")}
                              className="hover:bg-gray-50 text-gray-600 font-medium">
                              🩸 Demote to Donor
                            </button>
                          </li>
                        )}
