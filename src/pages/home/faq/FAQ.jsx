        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <motion.div 
              ...
              className=" rounded-3xl overflow-hidden border border-red-100/10 shadow-sm"
            >
              <button
              ...
              <AnimatePresence>
                {activeIndex === index && (
                  ...
                  >
                    <div className="px-8 pb-8 text-base-content/70 leading-relaxed border-t border-gray-50 pt-4">
                      {faq.answer}
                    </div>
                  </motion.div>
                )}
